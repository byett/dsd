...
* Make a new folder called board_files as This PC > Local Disk (C:) > Xilinx > 2025.1 (or whatever version you are running) > Vivado > data > boards > board_files 
* Copy and paste the nexys-a7-100t folder
* There should be four files in This PC > Local Disk (C:) > Xilinx > 2025.1 (or whatever version you are running) > Vivado > data > boards > board_files > nexys-a7-100t > D.0 > 1.3
  * board.xml
  * mig.prj
  * part0_pins.xml
  * preset.xml
