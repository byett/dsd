...
// Module: mux2x1
// Description: Top-level module, which is only required if 
// a) this file is specified as the top-level module in a synthesis tool. In that case, 
// synthesis tools look for a module with the same name as the file.
// b) this file is accessed by a testbench (tb) for testing purposes
