...
// Description: A basic half adder based off of the logic as presented on the slides.
...
module add_carry_out2 #(
    ...
    // we can instead use the concantenation operator on the left-hand side of the
...
//              carry in (and is therefore a full adder).
...
// Description: An extension of the previous full adder to add a signed overflow.
