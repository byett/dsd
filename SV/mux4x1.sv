...
// Module: mux2x1
// Description: A basic 2x1 mux using one of the several variations shown in mux2x1 previously.
// We'll be using this to create a structural 4x1 mux.
...
module mux4x1 (
    ...
    // will be automatically delcared with a width of 1 bit. However, it is
    // strongly recommended to not rely on that functionality and instead
    ...
    // We've used this in past examples already, though it does
    // hide the interface outside of basic testbenches
