...
* Two possible routes from here (recommended to read both before proceeding).

#### Option 1

 * Add Sources > Target language > Verilog > Simulator language > Verilog > Create File > Create a new source file of file type SystemVerilog called _**leddec**_ > Next
 ...
 * Sources > Design Sources > Right click to open, copy, and paste leddec.sv from the GitHub Raw > Save File
...
* Add Sources > Target language > Verilog > Simulator language > Verilog > Create File > Create three new source files of file type SystemVerilog called _**leddec**_, **_counter_**, and **_hexcount_** > Next
...
* Sources > Design Sources > Right click to open, copy, and paste leddec.sv, counter.sv, and hexcount.sv from the GitHub Raw, and save files
